...
### :pen\_fountain: 2、创建和初始化

### :pen\_fountain: 3、成员方法
...
### :pen\_fountain: 5、 map获取键对应值的几种方法

### :pen\_fountain: 6、`insert()`

### :pen\_fountain: 7、 `emplace()`和`emplace_hint()`

### :pen\_fountain: 8、 `multimap`容器

### :pen\_fountain: 9、const与static的map
...
### :pen\_fountain: 5、`insert()`

### :pen\_fountain:6、删除数据&#x20;

### :pen\_fountain: 7、 `emplace()`和`emplace_hint()`

### :pen\_fountain: 8、 `multiset`容器

## &#x20;:pencil2: 自定义关联式容器的排序规则
...
## :pencil2: key的有序性之自定义类型作为`key`

### :hamster: 1、简单方法: 重载operator<()操作符
...
#### :melon: 2.2、方法2: 重载operator()的类 <a href="#id-3.1" id="id-3.1"></a>
...
#### :melon: 2.3、方法3: less函数的模板定制 <a href="#id-3.1" id="id-3.1"></a>
