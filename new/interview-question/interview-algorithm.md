...
### :pen\_fountain: 2.1、`Fisher-Yates Shuffle`
...
### :pen\_fountain: 2.2、`Knuth-Durstenfeld Shuffle`
...
### :pen\_fountain: 2.3、`Inside-Out Algorithm`
...
输入：执行器总数n和任务总数m（ $$1\le n,m\le 10^6$$ ），每个人物有一个开始时间 $$a_i$$ 和一个运行时间 $$b_i(1\le a_i,b_i\le 10^9)$$ ，a是非降序，即任务是按时间顺序提交的。
